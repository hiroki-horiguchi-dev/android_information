...
# 9章 シェルスクリプト
Path を通す時に使う zash の ~/.zshrc あたりを今まで雰囲気でやってたので、
読めばちゃんと理解できるようになりそうだけど、今はいいかな。。
...
# 11章 プロセス管理
ここも絶対理解しておきたい
Android の非同期通信ともかぶってくるので

# 12章 ファイル管理
ここは後ででいいかな、、ファイルシステムの管理コマンド、ファイルシステムの概念と管理操作の習得が目的
スワップ領域の話とか、、部分的に Android 開発ともかぶってきそうなので読んでみてもいいけど優先度は低い